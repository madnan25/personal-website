...
const SONG_DESCRIPTIONS: Record<string, string> = {
  [normalizeKey("Ask it twice.mp3")]:
    ...
    [normalizeKey("I ain't consistent.mp3")]:
    "This song is an intense, fast-paced rap that captures the frustration of being underestimated and misjudged, especially by people in positions of authority. It tells the story of a self-made individual who built consistency through hardship, failure, and persistence rather than comfort or privilege. The lyrics contrast lived results—academic achievement, professional reliability, and entrepreneurial effort—with opinions that are mistaken for facts.",
